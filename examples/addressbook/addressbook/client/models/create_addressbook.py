...
class CreateAddressbook(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAddressbook:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAddressbook:
        """Create an instance of CreateAddressbook from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAddressbook.parse_obj(obj)

        _obj = CreateAddressbook.parse_obj(
            {
