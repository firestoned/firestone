...
from addressbook.client.api_response import ApiResponse, T as ApiResponseT
import addressbook.client.models
from addressbook.client import rest
from addressbook.client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(addressbook.client.models, klass)
