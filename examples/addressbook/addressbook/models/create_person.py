...
class CreatePerson(BaseModel):
    ...
    CreatePerson - a model defined in OpenAPI

        age: The age of this CreatePerson [Optional].
        first_name: The first_name of this CreatePerson [Optional].
        hobbies: The hobbies of this CreatePerson [Optional].
        last_name: The last_name of this CreatePerson [Optional].
    """
