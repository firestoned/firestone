...
pub async fn addressbook_address_key_addrtype_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<String, Error<AddressbookAddressKeyAddrtypeDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/addrtype", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyAddrtypeDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/addrtype
pub async fn addressbook_address_key_addrtype_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<String, Error<AddressbookAddressKeyAddrtypeGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyAddrtypeGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/addrtype
pub async fn addressbook_address_key_addrtype_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyAddrtypeHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyAddrtypeHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/addrtype
pub async fn addressbook_address_key_addrtype_put(configuration: &configuration::Configuration, body: &str, address_key: &str) -> Result<String, Error<AddressbookAddressKeyAddrtypePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyAddrtypePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// delete operation for /addressbook/{address_key}/city
pub async fn addressbook_address_key_city_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<String, Error<AddressbookAddressKeyCityDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/city", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyCityDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/city
pub async fn addressbook_address_key_city_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<String, Error<AddressbookAddressKeyCityGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
...
pub async fn addressbook_address_key_city_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyCityHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyCityHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/city
pub async fn addressbook_address_key_city_put(configuration: &configuration::Configuration, body: &str, address_key: &str) -> Result<String, Error<AddressbookAddressKeyCityPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_path_address_key = address_key;
...
pub async fn addressbook_address_key_country_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<String, Error<AddressbookAddressKeyCountryDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/country", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyCountryDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/country
pub async fn addressbook_address_key_country_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<String, Error<AddressbookAddressKeyCountryGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyCountryGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/country
pub async fn addressbook_address_key_country_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyCountryHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyCountryHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/country
pub async fn addressbook_address_key_country_put(configuration: &configuration::Configuration, body: &str, address_key: &str) -> Result<String, Error<AddressbookAddressKeyCountryPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyCountryPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Delete an address from this addressbook.
pub async fn addressbook_address_key_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<models::Addressbook, Error<AddressbookAddressKeyDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
...
pub async fn addressbook_address_key_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<models::Addressbook, Error<AddressbookAddressKeyGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
...
pub async fn addressbook_address_key_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
...
pub async fn addressbook_address_key_is_valid_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<bool, Error<AddressbookAddressKeyIsValidDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/is_valid", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyIsValidDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/is_valid
pub async fn addressbook_address_key_is_valid_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<bool, Error<AddressbookAddressKeyIsValidGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyIsValidGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/is_valid
pub async fn addressbook_address_key_is_valid_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyIsValidHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyIsValidHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/is_valid
pub async fn addressbook_address_key_is_valid_put(configuration: &configuration::Configuration, body: bool, address_key: &str) -> Result<bool, Error<AddressbookAddressKeyIsValidPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyIsValidPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// delete operation for /addressbook/{address_key}/people
pub async fn addressbook_address_key_people_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<Vec<String>, Error<AddressbookAddressKeyPeopleDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/people", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPeopleDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/people
pub async fn addressbook_address_key_people_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<Vec<String>, Error<AddressbookAddressKeyPeopleGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPeopleGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/people
pub async fn addressbook_address_key_people_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyPeopleHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPeopleHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/people
pub async fn addressbook_address_key_people_put(configuration: &configuration::Configuration, request_body: Vec<String>, address_key: &str) -> Result<Vec<String>, Error<AddressbookAddressKeyPeoplePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPeoplePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// delete operation for /addressbook/{address_key}/person
pub async fn addressbook_address_key_person_delete(configuration: &configuration::Configuration, address_key: &str, limit: Option<i32>, offset: Option<i32>) -> Result<models::Person, Error<AddressbookAddressKeyPersonDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_limit = limit;
    let p_query_offset = offset;

    let uri_str = format!("{}/addressbook/{address_key}/person", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPersonDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/person
pub async fn addressbook_address_key_person_get(configuration: &configuration::Configuration, address_key: &str, last_name: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<Vec<models::Person>, Error<AddressbookAddressKeyPersonGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPersonGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/person
pub async fn addressbook_address_key_person_head(configuration: &configuration::Configuration, address_key: &str, limit: Option<i32>, offset: Option<i32>) -> Result<(), Error<AddressbookAddressKeyPersonHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_limit = limit;
    let p_query_offset = offset;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPersonHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// patch operation for /addressbook/{address_key}/person
pub async fn addressbook_address_key_person_patch(configuration: &configuration::Configuration, address_key: &str, limit: Option<i32>, offset: Option<i32>) -> Result<models::Person, Error<AddressbookAddressKeyPersonPatchError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_limit = limit;
    let p_query_offset = offset;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPersonPatchError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// post operation for /addressbook/{address_key}/person
pub async fn addressbook_address_key_person_post(configuration: &configuration::Configuration, create_person: models::CreatePerson, address_key: &str, limit: Option<i32>, offset: Option<i32>) -> Result<models::CreatePerson, Error<AddressbookAddressKeyPersonPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyPersonPostError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Update an existing address in this addressbook, with the given address key.
pub async fn addressbook_address_key_put(configuration: &configuration::Configuration, update_addressbook: models::UpdateAddressbook, address_key: &str) -> Result<models::UpdateAddressbook, Error<AddressbookAddressKeyPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn addressbook_address_key_state_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<String, Error<AddressbookAddressKeyStateDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/state", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStateDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/state
pub async fn addressbook_address_key_state_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<String, Error<AddressbookAddressKeyStateGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStateGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/state
pub async fn addressbook_address_key_state_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyStateHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStateHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/state
pub async fn addressbook_address_key_state_put(configuration: &configuration::Configuration, body: &str, address_key: &str) -> Result<String, Error<AddressbookAddressKeyStatePutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStatePutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// delete operation for /addressbook/{address_key}/street
pub async fn addressbook_address_key_street_delete(configuration: &configuration::Configuration, address_key: &str) -> Result<String, Error<AddressbookAddressKeyStreetDeleteError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;

    let uri_str = format!("{}/addressbook/{address_key}/street", configuration.base_path, address_key=crate::apis::urlencode(p_path_address_key));
    let mut req_builder = configuration.client.request(reqwest::Method::DELETE, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStreetDeleteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// get operation for /addressbook/{address_key}/street
pub async fn addressbook_address_key_street_get(configuration: &configuration::Configuration, address_key: &str, city: Option<&str>) -> Result<String, Error<AddressbookAddressKeyStreetGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    let p_query_city = city;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStreetGetError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// head operation for /addressbook/{address_key}/street
pub async fn addressbook_address_key_street_head(configuration: &configuration::Configuration, address_key: &str) -> Result<(), Error<AddressbookAddressKeyStreetHeadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStreetHeadError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// put operation for /addressbook/{address_key}/street
pub async fn addressbook_address_key_street_put(configuration: &configuration::Configuration, body: &str, address_key: &str) -> Result<String, Error<AddressbookAddressKeyStreetPutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_body_body = body;
    let p_path_address_key = address_key;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<AddressbookAddressKeyStreetPutError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// List all addresses in this addressbook.
pub async fn addressbook_get(configuration: &configuration::Configuration, city: Option<&str>, limit: Option<i32>, offset: Option<i32>) -> Result<Vec<models::Addressbook>, Error<AddressbookGetError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_city = city;
    let p_query_limit = limit;
    let p_query_offset = offset;
...
pub async fn addressbook_post(configuration: &configuration::Configuration, create_addressbook: models::CreateAddressbook, limit: Option<i32>, offset: Option<i32>) -> Result<models::CreateAddressbook, Error<AddressbookPostError>> {
    // add a prefix to parameters to efficiently prevent name collisions
